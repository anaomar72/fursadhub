...
/**
 * Cryptographically secure opaque tokens for email verification / password reset / refresh
 * (CLAUDE.md sections 13, 17, 20 — never JWT, only the SHA-256 hash is ever persisted).
 */
@Component
