...
public record OrganizationMemberResponse(String membershipId, String email, String role) {

    public static OrganizationMemberResponse from(OrganizationMembershipService.Member member) {
        return new OrganizationMemberResponse(
                member.membership().getId().toString(), member.email(), member.membership().getRole().name());
    }
}
