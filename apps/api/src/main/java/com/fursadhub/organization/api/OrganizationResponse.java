...
public record OrganizationResponse(
        ...
        String website,
        String description,
        // Backend Phase B2 profile fields. Present here as well as on the public DTO because the
        // management screen must be able to READ what it edits. Omitting one on save no longer
        // clears it — see UpdateOrganizationRequest — but a form still cannot edit what it cannot
        // display.
        String industry,
        String city,
        String countryCode,
    ...
    public static OrganizationResponse from(Organization organization) {
        return new OrganizationResponse(
                ...
                organization.getCoverUploadedAt(),
